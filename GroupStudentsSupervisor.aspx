<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GroupStudentsSupervisor.aspx.cs" Inherits="GroupStudentsSupervisor" %>
...
<div class="container mt-5">
    <div class="text-center">
        <h3><asp:Label runat="server" id="lblGroupID">Group Name</asp:Label></h3>
        <p>Here is a list of the students in the group.</p>
       <div class="table-responsive table-borderless">
        ...
        <tbody class="border rounded">
            <tr>
                <th class="studentNames">1. (first), (last)</th>
                <td class="groupName">awesome possom</td>
                <td>12/2/2019</td>
                <td><span class="fileName">index.java</span>
                    <a href="#">
                        <i class="material-icons icons newTab">
                            open_in_new
                        </i>
                    </a>
                    <a href="#">
                        <i class="material-icons icons allFile">
                            call_to_action
                        </i>
                    </a>
                </td>
            ...
            <tr>
                <th class="studentNames">2. (first), (last)</th>
                <td class="groupName">awesome possom</td>
                <td>12/2/2019</td>
                <td><span class="fileName">index.java</span>
                    <a href="#">
            ...
            <tr>
                <th class="studentNames">(first), (last)</th>
                <td class="groupName">awesome possom</td>
                <td>12/2/2019</td>
                <td><span class="fileName">index.java</span>
                    <a href="#">
